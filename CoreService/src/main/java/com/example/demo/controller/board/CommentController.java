...
public class CommentController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "댓글 작성 실패 (게시글이 없음, 유효성 검증 실패 등)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
    ...
    public ResponseEntity<BaseResponse<CommentResponse>> createComment(
        ...
        CommentResponse response = commentService.createComment(authentication.getName(), request);
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "대댓글 작성 성공",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "400", description = "대댓글 작성 실패 (댓글이 없음, 유효성 검증 실패 등)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "401", description = "인증 실패 (유효하지 않은 토큰)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class)))
    })
    @PostMapping("/posts/{postId}/comments/{commentId}/replies")
    public ResponseEntity<BaseResponse<CommentResponse>> createReply(
            Authentication authentication,
            @Parameter(description = "게시글 ID", required = true, example = "1")
            @PathVariable Long postId,
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "댓글 수정 성공",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "400", description = "댓글 수정 실패 (권한 없음, 댓글이 없음 등)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "401", description = "인증 실패 (유효하지 않은 토큰)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class)))
    })
    ...
    public ResponseEntity<BaseResponse<CommentResponse>> updateComment(
        ...
        CommentResponse response = commentService.updateComment(authentication.getName(), commentId, request);
        return ResponseEntity.ok(BaseResponse.success(response));
    }
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "댓글 삭제 성공",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "400", description = "댓글 삭제 실패 (권한 없음, 댓글이 없음 등)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "401", description = "인증 실패 (유효하지 않은 토큰)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class)))
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "댓글 목록 조회 성공",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "400", description = "댓글 목록 조회 실패 (게시글이 없음 등)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "401", description = "인증 실패 (유효하지 않은 토큰)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class)))
    })
    ...
    public ResponseEntity<BaseResponse<List<CommentResponse>>> getCommentsByPostId(
        ...
        List<CommentResponse> comments = commentService.getCommentsByPostId(authentication.getName(), postId);
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "대댓글 목록 조회 성공",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "400", description = "대댓글 목록 조회 실패 (댓글이 없음 등)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class))),
            @ApiResponse(responseCode = "401", description = "인증 실패 (유효하지 않은 토큰)",
                    content = @Content(schema = @Schema(implementation = BaseResponse.class)))
    })
    @GetMapping("/posts/{postId}/comments/{commentId}/replies")
    public ResponseEntity<BaseResponse<List<CommentResponse>>> getRepliesByParentId(
            Authentication authentication,
            @Parameter(description = "게시글 ID", required = true, example = "1")
            @PathVariable Long postId,
            @Parameter(description = "댓글 ID", required = true, example = "1")
        ...
        List<CommentResponse> replies = commentService.getRepliesByParentId(authentication.getName(), commentId);
